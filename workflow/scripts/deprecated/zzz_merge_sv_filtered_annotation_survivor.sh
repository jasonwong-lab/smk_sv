...
# # map_formula=(["BND"]="10 2 0 0 1 1" ["DEL"]="10 2 0 0 1 {params.min_length_sv}" ["INS"]="10 2 0 0 1 {params.min_length_sv}" ["INV"]="10 2 0 0 1 {params.min_length_sv}" ["DUP"]="10 2 0 0 1 {params.min_length_sv}")
